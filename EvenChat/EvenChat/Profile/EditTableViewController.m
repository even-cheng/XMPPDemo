...
- (IBAction)saveEdit:(id)sender {
    ...
    if ([self.title isEqualToString:@"nickName"]) {
        
        myvCardTemp.nickname = self.EditTextField.text;
        
    } else if ([self.title isEqualToString:@"desc"]) {
        
        myvCardTemp.desc = self.EditTextField.text;
    }
